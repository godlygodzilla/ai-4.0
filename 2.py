...
def SJF(processes):
    ...
    print("\ntotal waiting time for SJF:",total_waiting_time)
    print("total turnaround time time for SJF:",total_turnaround_time)
...
def RR(processes, time_quantum):
    ...
    queue.append(processes[1])
    queue.append(processes[2])
    queue.append(processes[3])
    ...
    while True:
        ...
        if temp_burst[current_process.process_id - 1] > 0:
            ctr = 0
